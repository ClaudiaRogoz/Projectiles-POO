...
/**
 * Class that defines the behaviour of a triangle
...
public class Triangle extends BasicShape{
	...
	public void draw(Screen screen, int ref, Point centerGrav) {
		...
		startPoints[0] = centerGrav.translate(0, ref);
		endPoints[0] = centerGrav.translate(ref, ref);
		startPoints[1] = centerGrav.translate(0, ref);
		endPoints[1] = centerGrav.translate(-ref, ref);
		startPoints[2] = centerGrav.translate(-ref, ref);
		endPoints[2] = centerGrav.translate(0,-2 *ref);
		startPoints[3] = centerGrav.translate(0, -2 * ref );
